...
``` yaml
openapi-type: arm
tag: package-preview-2026-23
```


### Tag: package-preview-2026-23

These settings apply only when `--tag=package-preview-2026-23` is specified on the command line.

```yaml $(tag) == 'package-preview-2026-23'
input-file:
  - Microsoft.Cdn/preview/2026-23-32/cdn.json
```
### Tag: package-2017-10
