...
``` yaml
openapi-type: arm
tag: package-preview-3213-43
```


### Tag: package-preview-3213-43

These settings apply only when `--tag=package-preview-3213-43` is specified on the command line.

```yaml $(tag) == 'package-preview-3213-43'
input-file:
  - Microsoft.Cdn/preview/3213-43-34/cdn.json
```
### Tag: package-2017-10
