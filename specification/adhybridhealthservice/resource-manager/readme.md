...
``` yaml
openapi-type: arm
tag: package-preview-4325-34
```


### Tag: package-preview-4325-34

These settings apply only when `--tag=package-preview-4325-34` is specified on the command line.

```yaml $(tag) == 'package-preview-4325-34'
input-file:
  - >-
    Microsoft.ADHybridHealthService/preview/4325-34-23/ADHybridHealthService.json
```
### Tag: package-2014-01
