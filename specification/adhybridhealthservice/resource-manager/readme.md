...
``` yaml
openapi-type: arm
tag: package-preview-4123-23
```


### Tag: package-preview-4123-23

These settings apply only when `--tag=package-preview-4123-23` is specified on the command line.

```yaml $(tag) == 'package-preview-4123-23'
input-file:
  - >-
    Microsoft.ADHybridHealthService/preview/4123-23-32/ADHybridHealthService.json
```
### Tag: package-2014-01
