...
These settings apply only when `--tag=package-9.3` is specified on the command line.

```yaml $(tag) == 'package-9.3'
input-file:
  - Microsoft.ServiceFabric/stable/9.3/servicefabric.json
```
### Tag: 6.2
