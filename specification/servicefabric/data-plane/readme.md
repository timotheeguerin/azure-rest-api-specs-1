...
These settings apply only when `--tag=package-preview-7.0` is specified on the command line.

```yaml $(tag) == 'package-preview-7.0'
input-file:
  - Microsoft.ServiceFabric/preview/7.0/servicefabric.json
```
### Tag: 6.2
