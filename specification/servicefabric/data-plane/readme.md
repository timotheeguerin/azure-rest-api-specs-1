...
These settings apply only when `--tag=package-7.8` is specified on the command line.

```yaml $(tag) == 'package-7.8'
input-file:
  - Microsoft.ServiceFabric/stable/7.8/servicefabric.json
```
### Tag: 6.2
