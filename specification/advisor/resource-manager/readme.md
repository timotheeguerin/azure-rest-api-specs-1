...
``` yaml
openapi-type: arm
tag: package-preview-3123-32
```


### Tag: package-preview-3123-32

These settings apply only when `--tag=package-preview-3123-32` is specified on the command line.

```yaml $(tag) == 'package-preview-3123-32'
input-file:
  - Microsoft.Advisor/preview/3123-32-23/advisor.json
```
### Tag: package-2017-04
