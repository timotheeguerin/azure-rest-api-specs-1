...
``` yaml
openapi-type: arm
tag: package-preview-2000-01
```


### Tag: package-preview-2000-01

These settings apply only when `--tag=package-preview-2000-01` is specified on the command line.

```yaml $(tag) == 'package-preview-2000-01'
input-file:
  - Microsoft.Advisor/preview/2000-01-01/advisor.json
```
### Tag: package-2017-04
