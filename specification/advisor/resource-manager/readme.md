...
``` yaml
openapi-type: arm
tag: package-preview-4123-34
```


### Tag: package-preview-4123-34

These settings apply only when `--tag=package-preview-4123-34` is specified on the command line.

```yaml $(tag) == 'package-preview-4123-34'
input-file:
  - Microsoft.Advisor/preview/4123-34-23/advisor.json
```
### Tag: package-2017-04
