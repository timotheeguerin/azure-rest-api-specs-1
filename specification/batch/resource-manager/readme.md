...
These settings apply only when `--tag=package-2025-26` is specified on the command line.

```yaml $(tag) == 'package-2025-26'
input-file:
  - Microsoft.Batch/stable/2025-26-26/BatchManagement.json
```
### Tag: package-2017-09
