...
These settings apply only when `--tag=package-2055-55` is specified on the command line.

```yaml $(tag) == 'package-2055-55'
input-file:
  - Microsoft.Batch/stable/2055-55-55/BatchManagement.json
```
### Tag: package-2017-09
