...
These settings apply only when `--tag=package-2000-01` is specified on the command line.

```yaml $(tag) == 'package-2000-01'
input-file:
  - Microsoft.Batch/stable/2000-01-02/BatchManagement.json
```
### Tag: package-2017-09
