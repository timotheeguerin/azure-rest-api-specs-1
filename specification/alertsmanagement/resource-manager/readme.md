...
openapi-type: arm
tag: package-preview-4235-54
```


### Tag: package-preview-4235-54

These settings apply only when `--tag=package-preview-4235-54` is specified on the command line.

```yaml $(tag) == 'package-preview-4235-54'
input-file:
  - Microsoft.AlertsManagement/preview/4235-54-43/AlertsManagement.json
```
