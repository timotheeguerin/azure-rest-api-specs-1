...
These settings apply only when `--tag=package-1234-12` is specified on the command line.

```yaml $(tag) == 'package-1234-12'
input-file:
  - Microsoft.AlertsManagement/stable/1234-12-91/AlertsManagement.json
```
