...
These settings apply only when `--tag=package-2044-44` is specified on the command line.

```yaml $(tag) == 'package-2044-44'
input-file:
  - Microsoft.AzureStack/stable/2044-44-44/AzureStack.json
  - Microsoft.AzureStack/stable/2044-44-44/CustomerSubscription.json
  - Microsoft.AzureStack/stable/2044-44-44/Product.json
  - Microsoft.AzureStack/stable/2044-44-44/Registration.json
```
