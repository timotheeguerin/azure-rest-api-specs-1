...
openapi-type: arm
tag: package-preview-2143-23
```


### Tag: package-preview-2143-23

These settings apply only when `--tag=package-preview-2143-23` is specified on the command line.

```yaml $(tag) == 'package-preview-2143-23'
input-file:
  - Microsoft.AzureStack/preview/2143-23-23/AzureStack.json
  - Microsoft.AzureStack/preview/2143-23-23/CustomerSubscription.json
  - Microsoft.AzureStack/preview/2143-23-23/Product.json
  - Microsoft.AzureStack/preview/2143-23-23/Registration.json
```
