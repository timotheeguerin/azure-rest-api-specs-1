...
These settings apply only when `--tag=package-3213-23` is specified on the command line.

```yaml $(tag) == 'package-3213-23'
input-file:
  - Microsoft.Authorization/stable/3213-23-23/authorization-RACalls.json
```
### Tag: package-2015-07
