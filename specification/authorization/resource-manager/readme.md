...
These settings apply only when `--tag=package-preview-4321-32` is specified on the command line.

```yaml $(tag) == 'package-preview-4321-32'
input-file:
  - Microsoft.Authorization/preview/4321-32-23/authorization-ClassicAdminCalls.json
  - Microsoft.Authorization/preview/4321-32-23/authorization.json
```
### Tag: package-2015-07
