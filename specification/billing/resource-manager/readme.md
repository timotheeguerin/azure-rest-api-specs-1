...
These settings apply only when `--tag=package-4123-23` is specified on the command line.

```yaml $(tag) == 'package-4123-23'
input-file:
  - Microsoft.Billing/stable/4123-23-32/billing.json
```
