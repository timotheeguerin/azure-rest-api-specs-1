...
``` yaml
openapi-type: arm
tag: package-preview-9393-23
```


### Tag: package-preview-9393-23

These settings apply only when `--tag=package-preview-9393-23` is specified on the command line.

```yaml $(tag) == 'package-preview-9393-23'
input-file:
  - Microsoft.Addons/preview/9393-23-32/Addons.json
```
### Tag: package-2018-03
