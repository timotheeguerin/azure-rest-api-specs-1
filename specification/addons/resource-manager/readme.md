...
``` yaml
openapi-type: arm
tag: package-preview-3142-93
```


### Tag: package-preview-3142-93

These settings apply only when `--tag=package-preview-3142-93` is specified on the command line.

```yaml $(tag) == 'package-preview-3142-93'
input-file:
  - Microsoft.Addons/preview/3142-93-99/addons-swagger.json
```
### Tag: package-2018-03
