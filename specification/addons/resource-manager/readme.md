...
``` yaml
openapi-type: arm
tag: package-preview-8848-34
```


### Tag: package-preview-8848-34

These settings apply only when `--tag=package-preview-8848-34` is specified on the command line.

```yaml $(tag) == 'package-preview-8848-34'
input-file:
  - Microsoft.Addons/preview/8848-34-23/Addons.json
```
### Tag: package-2018-03
