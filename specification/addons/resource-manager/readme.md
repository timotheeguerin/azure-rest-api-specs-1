...
``` yaml
openapi-type: arm
tag: package-preview-2108-33
```


### Tag: package-preview-2108-33

These settings apply only when `--tag=package-preview-2108-33` is specified on the command line.

```yaml $(tag) == 'package-preview-2108-33'
input-file:
  - Microsoft.Addons/preview/2108-33-99/Addons.json
```
### Tag: package-2018-03
