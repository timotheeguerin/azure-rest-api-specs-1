...
``` yaml
openapi-type: arm
tag: package-preview-4323-34
```


### Tag: package-preview-4323-34

These settings apply only when `--tag=package-preview-4323-34` is specified on the command line.

```yaml $(tag) == 'package-preview-4323-34'
input-file:
  - Microsoft.Addons/preview/4323-34-32/Addons.json
```
### Tag: package-2018-03
