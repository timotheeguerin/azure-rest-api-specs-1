...
``` yaml
openapi-type: arm
tag: package-preview-4325-43
```


### Tag: package-preview-4325-43

These settings apply only when `--tag=package-preview-4325-43` is specified on the command line.

```yaml $(tag) == 'package-preview-4325-43'
input-file:
  - Microsoft.Addons/preview/4325-43-34/Addons.json
```
### Tag: package-2018-03
