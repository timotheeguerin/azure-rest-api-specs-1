...
These settings apply only when `--tag=package-3241-33` is specified on the command line.

```yaml $(tag) == 'package-3241-33'
input-file:
  - Microsoft.Addons/stable/3241-33-22/addons-swagger.json
```
### Tag: package-2018-03
