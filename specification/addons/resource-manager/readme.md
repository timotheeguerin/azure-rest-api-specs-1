...
These settings apply only when `--tag=package-2143-23` is specified on the command line.

```yaml $(tag) == 'package-2143-23'
input-file:
  - Microsoft.Addons/stable/2143-23-23/addons-swagger.json
```
### Tag: package-2018-03
