...
These settings apply only when `--tag=package-4323-01` is specified on the command line.

```yaml $(tag) == 'package-4323-01'
input-file:
  - Microsoft.Addons/stable/4323-01-01/addons-swagger.json
```
### Tag: package-2018-03
