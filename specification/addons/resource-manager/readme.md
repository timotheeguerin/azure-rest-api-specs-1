...
``` yaml
openapi-type: arm
tag: package-preview-2017-32
```


### Tag: package-preview-2017-32

These settings apply only when `--tag=package-preview-2017-32` is specified on the command line.

```yaml $(tag) == 'package-preview-2017-32'
input-file:
  - Microsoft.Addons/preview/2017-32-54/Addons.json
```
### Tag: package-2018-03
