...
These settings apply only when `--tag=package-9973-32` is specified on the command line.

```yaml $(tag) == 'package-9973-32'
input-file:
  - Microsoft.AnalysisServices/stable/9973-32-23/analysisservices.json
```
### Tag: package-2017-08
