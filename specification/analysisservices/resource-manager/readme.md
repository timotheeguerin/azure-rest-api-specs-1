...
These settings apply only when `--tag=package-3173-32` is specified on the command line.

```yaml $(tag) == 'package-3173-32'
input-file:
  - Microsoft.AnalysisServices/stable/3173-32-23/analysisservices.json
```
### Tag: package-2017-08
