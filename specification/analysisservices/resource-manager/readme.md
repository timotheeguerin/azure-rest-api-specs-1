...
These settings apply only when `--tag=package-9992-23` is specified on the command line.

```yaml $(tag) == 'package-9992-23'
input-file:
  - Microsoft.AnalysisServices/stable/9992-23-12/analysisservices.json
```
### Tag: package-2017-08
