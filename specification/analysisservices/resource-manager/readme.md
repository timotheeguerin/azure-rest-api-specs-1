...
These settings apply only when `--tag=package-9773-32` is specified on the command line.

```yaml $(tag) == 'package-9773-32'
input-file:
  - Microsoft.AnalysisServices/stable/9773-32-25/analysisservices.json
```
### Tag: package-2017-08
